        ...
        4: [
            function (t, e, i) {
                !(function (t, n) {
                    ...
                    function e() {
                        for (
                            var e = t("div", n.CONTROLS), i = t("button", n.CONTROLS_CLOSE), l = t("button", [n.CONTROLS_ARROW, n.CONTROLS_NEXT]), h = t("button", [n.CONTROLS_ARROW, n.CONTROLS_PREV]), a = [i, l, h], u = 0;
                            u < a.length;
                            u++
                        )
                            e.appendChild(a[u]);
                    ...
                    return (
                        ...
                        (s.prototype._handleThumbClick = function (t) {
                            this._thumb != t.target && ((this._thumb = t.target), (this._thumbIndex = this._thumbs.indexOf(this._thumb)), (this._fullImg = this._fullImgs[this._thumbIndex])),
                                this._setupComplete && this._fullImgsLoaded && !this._fullImgOpen && (this._activateFullImg.call(this), this._activateControls.call(this), this._activateFullBox.call(this), this._disableScroll());
                        }),
                    ...
                    var e = {},
                        ...
                        r = function (t, e) {
                            ...
                            for (var n, s = 0; s < t.length; s++)
                                (n = t[s]), (n.style.width = (e * parseInt(n.getAttribute("data-width"))) / parseInt(n.getAttribute("data-height")) + "px"), (n.style.height = e + "px"), n.classList.add("layout-completed");
                        };
                    return (
                        (e.init = function (t) {
                            t = t || {};
